		...
		<div class="container">
			...
			<div class="row feedback-contents justify-content-between align-items-center">
				...
				<div class="col-lg-5 feedback-right relative d-flex justify-content-center align-items-center">
					...
					<a class="play-btn" href="https://www.youtube.com/watch?v=ARA0AxrnHdM"><img class="img-fluid" src="<?php echo base_url(); ?>/public/front/img/play-btn.png" alt=""></a>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				<div class="active-testimonial">
					<div class="single-testimonial item d-flex flex-row">
						<div class="thumb">
							<img class="img-fluid" src="<?php echo base_url(); ?>/public/front/img/about/user1.png" alt="">
						</div>
						<div class="desc">
							<p>
					...
					<div class="single-testimonial item d-flex flex-row">
						<div class="thumb">
							<img class="img-fluid" src="<?php echo base_url(); ?>/public/front/img/about/user2.png" alt="">
						</div>
						<div class="desc">
							<p>
			...
			<div class="brand-wrap">
				<div class="row align-items-center active-brand-carusel justify-content-start no-gutters">
					<div class="col single-brand">
						<a href="#"><img class="mx-auto" src="<?php echo base_url(); ?>/public/front/img/l1.png" alt=""></a>
					</div>
					<div class="col single-brand">
						<a href="#"><img class="mx-auto" src="<?php echo base_url(); ?>/public/front/img/l2.png" alt=""></a>
					</div>
					<div class="col single-brand">
						<a href="#"><img class="mx-auto" src="<?php echo base_url(); ?>/public/front/img/l3.png" alt=""></a>
					</div>
					<div class="col single-brand">
						<a href="#"><img class="mx-auto" src="<?php echo base_url(); ?>/public/front/img/l4.png" alt=""></a>
					</div>
					<div class="col single-brand">
						<a href="#"><img class="mx-auto" src="<?php echo base_url(); ?>/public/front/img/l5.png" alt=""></a>
					</div>
				</div>
			</div>
		</div>
